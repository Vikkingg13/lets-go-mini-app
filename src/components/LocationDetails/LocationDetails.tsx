...
{location.link && (
          ...
          <div className="space-y-3 pt-2">
            <button 
              className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-semibold hover:bg-blue-700 active:scale-98 transition-all flex items-center justify-center gap-2 shadow-md"
              onClick={() => {
                // Интеграция с картами
                const url = `https://yandex.ru/maps/?text=${encodeURIComponent(location.address)}`;
