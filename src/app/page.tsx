...
export default function Home() {
  ...
  return (
    <Page back={false}>
      <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col font-bold text-black">
        <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t z-50">
        {/* Header */}
